...
import { apiBaseUrl, dashboardDemoUrl } from "@/lib/marketing-links";
...
export default function StatusPage() {
  ...
  useEffect(() => {
    async function run() {
      ...
      next.push({ name: "Marketing (livia.io)", ok: true, detail: "You are viewing it" });
      setChecks(next);
      setLoading(false);
    }
    void run();
