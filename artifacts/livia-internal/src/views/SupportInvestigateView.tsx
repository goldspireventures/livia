...
export function SupportInvestigateView() {
  ...
  return (
    <div>
      <p style={{ fontSize: 13, color: "#94a3b8", lineHeight: 1.5, maxWidth: 520, margin: "0 0 16px" }}>
        Paste the <code>requestId</code> from an error toast or API response. Use this when Support inbox context is not enough.
      </p>
      ...
      >
        ...
        <div style={{ display: "grid", gap: 12 }}>
          {selectedPoint ? (
            <section style={{ ...cardStyle, fontSize: 12 }}>
          ...
          {trace ? (
            <section style={{ ...cardStyle, fontSize: 12 }} data-testid="support-investigate-trace">
            ...
            <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>
              Trace results and surface runbook hints appear here after lookup.
            </p>
          )}
        </div>
      </div>
