...
export function WorkforceJoinView({ role }: { role: InternalOpsRole }) {
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      <h2 style={{ fontSize: 20, margin: "0 0 8px" }}>Workforce onboarding</h2>
      <p style={{ color: "#94a3b8", lineHeight: 1.55, margin: "0 0 16px" }}>
        One front door for company access — Clerk, internal ops, staging, and role-specific tooling. Operator:{" "}
        <code>{operator || "(set at sign-in)"}</code>
      </p>
