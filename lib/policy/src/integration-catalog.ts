...
export const INTEGRATION_CATALOG: IntegrationCatalogEntry[] = [
  ...
  {
    id: "migration_acuity",
    label: "Previous scheduler (OAuth A)",
    category: "scheduling",
    mode: "oauth",
  ...
  {
    id: "migration_square",
    label: "Previous scheduler (OAuth B)",
    category: "scheduling",
    mode: "oauth",
    envKey: "SQUARE_APPLICATION_ID",
  ...
  {
    id: "migration_fresha",
    label: "Salon marketplace (partner read)",
    category: "scheduling",
    mode: "oauth",
    envKey: "FRESHA_CLIENT_ID",
    ownerSummary: "Partner read of clients and bookings when Fresha credentials are configured.",
    selfServe: false,
  },
  {
