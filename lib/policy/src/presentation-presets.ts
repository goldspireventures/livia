  ...
  "event-vendors": [
    {
      ...
      label: "Atelier",
      description: "Gallery enquire-first — hero-led leads, roomy Today, warm decor studio.",
      isDefault: true,
      tokens: {
        colorMode: "light",
        density: "comfortable",
    ...
    },
    {
      ...
      description: "Muted luxury — quote pipeline on Today, milestone deposits front and centre.",
      isDefault: false,
      tokens: {
        colorMode: "light",
        density: "comfortable",
    ...
    },
    {
      ...
      vertical: "event-vendors",
      label: "Party Pop",
      description: "Birthday and kids parties — playful menu grid, bright quote cards.",
      isDefault: false,
      tokens: {
        colorMode: "light",
        density: "comfortable",
