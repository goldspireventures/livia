...
import type {
  ...
  Invitation,
  ListAtRiskRelationships200,
  ListAtRiskRelationshipsParams,
  ...
  ListTimeOffParams,
  LivSetupAssistRequest,
  LivSetupAssistResponse,
  LivSetupGuidedFlowResponse,
  ...
  PatchTenantCapabilityInstanceRequest,
  PeerInsights,
  ...
  TwinCommerceSnapshot,
  TwinIntelligenceDailyResult,
 ...
 */
export const getGetMyCapabilitiesUrl = (params?: GetMyCapabilitiesParams) => {
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetMyCapabilitiesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getMyCapabilities>>
  > = ({ signal }) => getMyCapabilities(params, { signal, ...requestOptions });
...
export type GetMyCapabilitiesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMyCapabilities>>
>;
export type GetMyCapabilitiesQueryError = ErrorType<
  UnauthorizedResponse | ForbiddenResponse | NotFoundResponse
>;
...
>(
  ...
  const queryOptions = getGetMyCapabilitiesQueryOptions(params, options);
 ...
 */
export const getListAtRiskRelationshipsUrl = (
  businessId: string,
  params?: ListAtRiskRelationshipsParams,
) => {
  const normalizedParams = new URLSearchParams();
...
export const listAtRiskRelationships = async (
  businessId: string,
  params?: ListAtRiskRelationshipsParams,
  options?: RequestInit,
): Promise<ListAtRiskRelationships200> => {
  return customFetch<ListAtRiskRelationships200>(
    getListAtRiskRelationshipsUrl(businessId, params),
    {
      ...options,
      method: "GET",
    },
...
export const getListAtRiskRelationshipsQueryKey = (
  businessId: string,
  params?: ListAtRiskRelationshipsParams,
) => {
  return [
...
export const getListAtRiskRelationshipsQueryOptions = <
  TData = Awaited<ReturnType<typeof listAtRiskRelationships>>,
  TError = ErrorType<UnauthorizedResponse>,
>(
  businessId: string,
  params?: ListAtRiskRelationshipsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listAtRiskRelationships>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getListAtRiskRelationshipsQueryKey(businessId, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listAtRiskRelationships>>
  > = ({ signal }) =>
    listAtRiskRelationships(businessId, params, { signal, ...requestOptions });
...
export type ListAtRiskRelationshipsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listAtRiskRelationships>>
>;
export type ListAtRiskRelationshipsQueryError = ErrorType<UnauthorizedResponse>;

/**
 * @summary Guests drifting or lapsed (relationship layer v1)
 */

export function useListAtRiskRelationships<
  TData = Awaited<ReturnType<typeof listAtRiskRelationships>>,
  TError = ErrorType<UnauthorizedResponse>,
>(
  businessId: string,
  ...
  const queryOptions = getListAtRiskRelationshipsQueryOptions(
    businessId,
    params,
    options,
  );
...
export const patchTenantCapabilityInstance = async (
  businessId: string,
  capabilityId: string,
  patchTenantCapabilityInstanceRequest: PatchTenantCapabilityInstanceRequest,
  options?: RequestInit,
): Promise<TenantCapabilitiesResponse> => {
  return customFetch<TenantCapabilitiesResponse>(
    getPatchTenantCapabilityInstanceUrl(businessId, capabilityId),
    {
      ...
      method: "PATCH",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(patchTenantCapabilityInstanceRequest),
    },
  );
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    {
      businessId: string;
      capabilityId: string;
      data: BodyType<PatchTenantCapabilityInstanceRequest>;
    },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
...
export type PatchTenantCapabilityInstanceMutationBody =
  BodyType<PatchTenantCapabilityInstanceRequest>;
 ...
 */
export const getGetTwinObservationsUrl = (businessId: string) => {
  return `/api/businesses/${businessId}/twin/observations`;
};

export const getTwinObservations = async (
  businessId: string,
  options?: RequestInit,
): Promise<TwinObservationsBundle> => {
  return customFetch<TwinObservationsBundle>(
    getGetTwinObservationsUrl(businessId),
    {
      ...options,
      method: "GET",
    },
...
export const getGetTwinObservationsQueryKey = (businessId: string) => {
  return [`/api/businesses/${businessId}/twin/observations`] as const;
};

export const getGetTwinObservationsQueryOptions = <
  TData = Awaited<ReturnType<typeof getTwinObservations>>,
  TError = ErrorType<UnauthorizedResponse>,
>(
  businessId: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getTwinObservations>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetTwinObservationsQueryKey(businessId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getTwinObservations>>
  > = ({ signal }) =>
    getTwinObservations(businessId, { signal, ...requestOptions });
...
export type GetTwinObservationsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTwinObservations>>
>;
export type GetTwinObservationsQueryError = ErrorType<UnauthorizedResponse>;

/**
 * @summary Persisted Twin observations with evidence
 */

export function useGetTwinObservations<
  TData = Awaited<ReturnType<typeof getTwinObservations>>,
  TError = ErrorType<UnauthorizedResponse>,
>(
  businessId: string,
  ...
  const queryOptions = getGetTwinObservationsQueryOptions(businessId, options);
 ...
 */
export const getSyncTwinIntelligenceUrl = (businessId: string) => {
  return `/api/businesses/${businessId}/twin/sync`;
};

export const syncTwinIntelligence = async (
  businessId: string,
  options?: RequestInit,
): Promise<TwinIntelligenceDailyResult> => {
  return customFetch<TwinIntelligenceDailyResult>(
    getSyncTwinIntelligenceUrl(businessId),
    {
      ...options,
      method: "POST",
    },
...
export const getSyncTwinIntelligenceMutationOptions = <
  TError = ErrorType<UnauthorizedResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof syncTwinIntelligence>>,
    TError,
    { businessId: string },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["syncTwinIntelligence"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return syncTwinIntelligence(businessId, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SyncTwinIntelligenceMutationResult = NonNullable<
  Awaited<ReturnType<typeof syncTwinIntelligence>>
>;

export type SyncTwinIntelligenceMutationError = ErrorType<UnauthorizedResponse>;

/**
 * @summary Materialize Twin observations now (owner/admin)
 */
export const useSyncTwinIntelligence = <
  TError = ErrorType<UnauthorizedResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSyncTwinIntelligenceMutationOptions(options));
};
...
export const getLivSetupGuidedFlow = async (
  businessId: string,
  options?: RequestInit,
): Promise<LivSetupGuidedFlowResponse> => {
  return customFetch<LivSetupGuidedFlowResponse>(
...
export const postLivSetupAssist = async (
  businessId: string,
  livSetupAssistRequest: LivSetupAssistRequest,
  options?: RequestInit,
): Promise<LivSetupAssistResponse> => {
  return customFetch<LivSetupAssistResponse>(
    getPostLivSetupAssistUrl(businessId),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(livSetupAssistRequest),
    },
  );
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { businessId: string; data: BodyType<LivSetupAssistRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type PostLivSetupAssistMutationResult = NonNullable<
  Awaited<ReturnType<typeof postLivSetupAssist>>
>;
export type PostLivSetupAssistMutationBody = BodyType<LivSetupAssistRequest>;
...
export type PostLivOwnerAssistMutationResult = NonNullable<
  Awaited<ReturnType<typeof postLivOwnerAssist>>
>;
export type PostLivOwnerAssistMutationBody = BodyType<LivSetupAssistRequest>;
...
export const getCommerceSnapshot = async (
  businessId: string,
  options?: RequestInit,
): Promise<TwinCommerceSnapshot> => {
  return customFetch<TwinCommerceSnapshot>(
    getGetCommerceSnapshotUrl(businessId),
    {
      ...options,
      method: "GET",
    },
...
export type GetCommerceSnapshotQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCommerceSnapshot>>
>;
export type GetCommerceSnapshotQueryError = ErrorType<
  UnauthorizedResponse | NotFoundResponse
>;
