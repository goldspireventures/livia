...
export const DEMO_OWNER_SHORT_BY_SLUG: Record<string, string> = {
  ...
  "polish-nail-studio-dublin": "polish",
  "arch-brow-bar-dublin": "archbrow",
  "silk-wax-studio-dublin": "silkwax",
  "glow-facial-studio-dublin": "glow",
  "bronze-tan-booth-dublin": "bronze",
  "inked-lip-studio-dublin": "inkedlip",
  "roam-beauty-dublin": "roambeauty",
  "lash-host-dublin": "lashhost",
  "prism-beauty-studio-dublin": "prism",
  "hue-colour-studio-dublin": "hue",
  "clipchair-host-dublin": "cliphost",
  "roam-cuts-dublin": "roamcuts",
  "float-lab-dublin": "float",
  "sage-holistic-cork": "sage",
  "dual-spa-dublin": "dualspa",
  "tidal-spa-group-dublin": "tidalhq",
  "tidal-spa-cork": "tidalcork",
  "flash-ink-galway": "flashink",
  "steel-piercing-galway": "steel",
  "laser-skin-clinic-dublin": "laser",
  "align-chiro-cork": "chiro",
  "tempo-class-studio-dublin": "tempo",
  "paws-mobile-dublin": "pawsmobile",
  "shine-mobile-belfast": "shinemobile",
  "vow-wedding-styling-dublin": "vow",
};
