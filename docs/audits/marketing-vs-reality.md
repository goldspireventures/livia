...
| 4a | C | Pricing tiers (F9: Solo €79 · Studio €149 · Chain €249/shop · Host €99+€19) displayed without a checkout | Stripe Billing not live. No checkout link, no subscription state, no webhook. | `rewrite-claim` | founder | **Edit applied 2026-05-06 + 2026-06-02:** Pricing derives from `PLAN_CATALOGUE`; beta free; legacy €49/99/149 retired — see `PRICING-RECONCILIATION-2026-06-02.md`. |
