# Livia Source of Truth

## Purpose

This is Livia’s highest-level product and engineering constitution.

Cursor must read this before major work and follow it over any informal assumptions.

**Repo note:** Implementation **phase numbers** and the HTTP roadmap live in [`docs/LIVIA_BUILD_PLAN.md`](../LIVIA_BUILD_PLAN.md) Part **D**. Use [`LIVIA_PHASE_STATUS.md`](./LIVIA_PHASE_STATUS.md) for crosswalk from older “elite” numbering and current status.

---

## 1. What Livia Is

Livia is a mobile-first, multi-tenant operating platform for service businesses.
...
> Livia becomes the operating system for service businesses.

---

## 2. Who Livia Serves

Livia must support many verticals:
- barbers
- salons
- nail techs
- lash techs
...
Livia includes or will include:
...
Build Livia as if it will power thousands of businesses.
...
> Would this still make sense if Livia had 10,000 businesses using it?
